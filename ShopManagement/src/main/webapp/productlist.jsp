...
<body>
	...
	<div id="tb_productinfo" style="padding: 2px 5px;">
		<a href="javascript:void(0)" class="easyui-linkbutton"
			...
			href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-remove" onclick="removeProduct();" plain="true">下架</a>
			<a
            			href="javascript:void(0)" class="easyui-linkbutton"
            			iconCls="icon-remove" onclick="upProduct();" plain="true"上架</a>
	</div>
			...
			<form id="ff_productinfo" method="POST" action=""
				...
				<table cellpadding="5">
					...
					<tr>
						<td>商品类型:</td>
						<td>
						<input style="width: 150px;" id="type.id"
					...
					<tr>
						<td>商品品牌:</td>
						<td>
						<input class="easyui-textbox" type="text" id="brand"
							name="brand" data-options="required:true"></input></td>
					</tr>
					<tr>
						<td>商品数量:</td>
						<td>
						<input class="easyui-textbox" type="text" id="num"
							name="num" data-options="required:true"></input></td>
					</tr>
					<tr>
						<td>商品价格:</td>
						<td>
						<input class="easyui-textbox" type="text" id="price"
							name="price" data-options="required:true"></input></td>
					</tr>
					<tr>
						<td>商品描述:</td>
						<td>
						<input class="easyui-textbox" name="intro" id="intro"
	...
	<script type="text/javascript">
		...
		function removeProduct() {
			...
			if (rows.length > 0) {
				...
				$.messager.alert('提示', '请选择要下架的行', 'info');
			}
		}
		...
		function upProduct() {
			...
			if (rows.length > 0) {
				...
				$.messager.alert('提示', '请选择要上架的行', 'info');
			}
		}
